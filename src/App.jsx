...
function TabViajeros({ esPremium, onUpgrade, usuario, onEnviarSolicitud, onResponderSolicitud, onCambioSolicitudes, onToast }) {
  ...
  <div style={{ background:BRAND.bone, minHeight:"100dvh", paddingBottom:"7rem" }}>
    ...
    {drawerPerfil && (
      <div onClick={() => setDrawerPerfil(null)} style={{ position:"fixed", inset:0, background:"rgba(11,20,38,0.55)", backdropFilter:"blur(4px)", zIndex:250, display:"flex", alignItems:"center", justifyContent:"center", padding:"1.25rem" }}>
        <div onClick={e => e.stopPropagation()} style={{ background:"#fff", borderRadius:"20px", width:"100%", maxWidth:"400px", padding:"1.5rem 1.25rem 1.75rem", maxHeight:"85vh", overflowY:"auto" }}>
